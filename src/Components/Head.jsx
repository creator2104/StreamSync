    ...
    <div className="flex shadow-lg">
      ...
      <div className="p-2 mx-50 w-7/12">
        <input
          type="text"
          placeholder="Search"
          className="w-3/4 mt-2 border border-gray-400 rounded-l-full p-1 px-4 hover:border-gray-500 focus:outline-none focus:border-gray-500 focus:border-2"
        />
        <button className="bg-gray-200 rounded-r-full cursor-pointer px-4 py-[5px] hover:bg-gray-300">
          Search
        </button>
      </div>
